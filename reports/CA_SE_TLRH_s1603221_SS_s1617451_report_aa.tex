...
\begin{figure}
    ...
    \caption{Fraction of initial present in stars of a cluster over time.}\label{fig:massfraction}
\end{figure}
...
To find the stars that are considered gravitationally bound the HOP algorithm is used \citep{1998ApJ...498..137E}.
\begin{figure}
    \centering
